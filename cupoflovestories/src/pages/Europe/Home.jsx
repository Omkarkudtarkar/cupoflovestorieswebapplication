...
export default function EuropeHome() {
  return (
    <div className="pt-24" style={{ backgroundImage:"url('/backgrounds/vintage.jpg')", backgroundRepeat:'repeat', backgroundSize:'400px 400px' }}>

      <ScrollReveal>
        <section className="relative h-[85vh] w-full">
          <img src="/images/europe/cover.jpg" alt="Wedding" className="absolute inset-0 w-full h-full object-cover" />
          ...
          <div className="relative z-10 h-full flex flex-col items-center justify-center text-center px-6 text-white">
            ...
            <Link to="/europe/collection" className="border border-white px-10 py-4 hover:bg-white hover:text-black transition">View The Collection</Link>
          </div>
        </section>
      </ScrollReveal>
      ...
      <ScrollReveal>
        <section className="max-w-4xl mx-auto px-6 py-28 text-center">
          ...
          <p className="text-lg text-gray-700 leading-relaxed">
            We document stories across cities, coastlines and old streets — focusing on natural emotion, movement and timeless romance. Every image is built to feel like cinema.
          </p>
        </section>
      </ScrollReveal>
      ...
      <ScrollReveal>
        <section className="py-28 px-6 text-center bg-white">
          ...
          <Link to="/europe/information" className="border border-black px-8 py-3 hover:bg-black hover:text-white transition">View Experience</Link>
        </section>
      </ScrollReveal>
      ...
      <ScrollReveal>
        <section className="py-28 text-center">
          ...
          <Link to="/europe/inquire" className="border border-black px-10 py-4 hover:bg-black hover:text-white transition">Start Your Inquiry</Link>
        </section>
      </ScrollReveal>
