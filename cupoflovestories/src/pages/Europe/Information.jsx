      ...
      <section className="py-12 px-4 md:px-6 relative" style={{ backgroundColor: '#ffffff' }}>
        ...
        <div className="relative z-10">
          ...
          <div className="max-w-5xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-8">
            {[
              ['Wedding Coverage', 'Full day or partial, moments from prep to celebration.', 'Starting at EUR 2,000'],
              ['Portraits & Couples', 'Emotional portrait sessions in natural light.', 'Starting at EUR 300'],
