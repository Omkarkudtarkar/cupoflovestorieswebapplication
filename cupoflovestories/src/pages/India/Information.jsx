...
export default function IndiaInformation() {
  return (
    <div className="pt-24">
      <section className="text-center pt-32 pb-12 px-6">
        ...
        <ScrollReveal delay="delay-1">
          <p className="text-lg text-gray-700 max-w-3xl mx-auto">
            Every story is unique, so your experience and coverage should be too. We create custom cinematic photo experiences
            that reflect your personality and moments.
          </p>
        </ScrollReveal>
      </section>
      ...
      <section className="py-12 px-4 md:px-6 relative" style={{ backgroundColor: '#ffffff' }}>
        ...
        <div className="relative z-10">
          ...
          <div className="max-w-5xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-8">
            {[
              ['Wedding Coverage', 'Full day or partial, moments from prep to celebration.', 'Starting at INR XX,XXX'],
              ['Portraits & Couples', 'Emotional portrait sessions in natural light.', 'Starting at INR X,XXX'],
      ...
      <section className="py-12 px-6">
        ...
        <div className="max-w-4xl mx-auto space-y-6 text-gray-700">
          {[
            ['How do we book a session?', 'Send an inquiry via our form or email and we will take it from there.'],
            ['Do you travel?', 'Yes, both within India and internationally, travel fees may apply.'],
