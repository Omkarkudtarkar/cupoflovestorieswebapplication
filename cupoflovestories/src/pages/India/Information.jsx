    ...
    <div className="pt-24 bg-[#f5f3ef]">
      ...
      <section className="bg-white py-12 px-4 md:px-6">
        ...
        <div className="max-w-5xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-8">
          {[
            ['Wedding Coverage', 'Full day or partial — moments from prep to celebration.', 'Starting at ₹XX,XXX'],
            ['Portraits & Couples', 'Emotional portrait sessions in natural light.', 'Starting at ₹X,XXX'],
